...
class S {
  ...
  String get getnofrench {
    return Intl.message(
      'No frenchies Found Of That Vender',
      name: 'getnofrench',
      desc: '',
      args: [],
    );
  ...
  String get pickupbydriver {
    return Intl.message(
      'Pickup By Delivery Boy',
      name: 'pickupbydriver',
      desc: '',
      args: [],
    );
