...
class AppColors {
  ...
  // static const Color gold = Color(0xFF00B894);
  static const Color gold = Color(0xFF0098FB);
  ...
  // static const Color goldenButton = Color(0xFF00B894);
   static const Color goldenButton = Color(0xFF0098FB);
